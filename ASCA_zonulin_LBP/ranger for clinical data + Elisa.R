...
for (d in c(30, 90)) {
  for (i in 0:4) {
    train = read_csv(paste0("train3_", d, "_imp", i, ".csv"))
    test = read.csv(paste0("test3_", d, "_imp", i, ".csv"))
...
for (d in c(30, 90)) {
  for (i in 0:4) {
    ...
    write_csv(train.sel, paste0("train3_", d, "_sel", i, ".csv"))
    write_csv(test.sel, paste0("test3_", d, "_", i, ".csv"))
  }
}
